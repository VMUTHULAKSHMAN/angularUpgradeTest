...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(ReactiveUserDetailsService userDetailsService, TokenProvider tokenProvider, JHipsterProperties jHipsterProperties, SecurityProblemSupport problemSupport, CorsWebFilter corsWebFilter) {
