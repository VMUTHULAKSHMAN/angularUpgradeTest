...
class UserResourceIT {
    ...
    void getAllUsers() {
        ...
        // Get all the users
        AdminUserDTO foundUser = webTestClient.get().uri("/api/admin/users?sort=id,desc")
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus().isOk()
            .expectHeader().contentType(MediaType.APPLICATION_JSON)
            .returnResult(AdminUserDTO.class).getResponseBody().blockFirst();
    ...
    void getUser() {
        ...
        webTestClient.get().uri("/api/admin/users/{login}", user.getLogin())
            ...
            .jsonPath("$.langKey").isEqualTo(DEFAULT_LANGKEY)            .jsonPath("$.authorities")
